...
export default function CallToAction() {
  return (
    <section className="mx-6 mb-24 grid gap-8 text-center lg:flex lg:justify-around lg:my-28">
      ...
      <div className="flex flex-col gap-4 md:relative md:items-center lg:flex-row">
        <input
          ...
          className="bg-white font-bold px-14 py-3.5 rounded-3xl shadow-lg md:text-left md:px-8 md:w-3/5 lg:w-[35rem]"
        />
